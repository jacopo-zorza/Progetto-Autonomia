...
export default function Login(): React.ReactElement {
  ...
  return React.createElement(
    ...
    React.createElement('h2', { className: 'text-xl pa-heading mb-4' }, 'Login'),
    React.createElement(
      'form',
      { onSubmit },
      ...
      React.createElement('div', { className: 'flex justify-end' }, React.createElement('button', { type: 'submit', className: 'pa-btn' }, 'Accedi'))
    )
  )
}
